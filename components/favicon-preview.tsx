...
export function FaviconPreview({ config }: FaviconPreviewProps) {
  ...
  const getLucideIconPath = (iconName: string) => {
    // Paths exactos de Lucide React - TODOS los 64 iconos
    const lucidePaths: Record<string, string> = {
      // Iconos originales (32)
      ...
      rocket:
        '<path d="M4.5 16.5c-1.5 1.3-2 3.6-2 3.6s2.3-.5 3.6-2L7.5 16.5"/><path d="M22 3 14 11l-1.5-1.5"/><path d="M9 12 7.5 10.5"/><path d="M16 8 14.5 6.5"/>',
      trophy:
      ...
      wifi: '<path d="m12 20 0 0"/><path d="M2 8.82a15 15 0 0 1 20 0"/><path d="M5 12.859a10 10 0 0 1 14 0"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/>',
      bluetooth: '<path d="m7 7 10 10-5 5V2l5 5L7 17"/>',
      battery:
        '<rect width="16" height="10" x="2" y="7" rx="2" ry="2"/><line x1="6" x2="6" y1="11" y2="13"/><line x1="10" x2="10" y1="11" y2="13"/><line x1="14" x2="14" y1="11" y2="13"/>',
      ...
      tool: '<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="m18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4Z"/>',
    };
